...
import { Send, UserStar, LogOut } from "lucide-react";
        ...
        <>
            <div className="fixed flex flex-col h-screen p-4 px-2 border-r border-gray-300 bg-white w-45 z-10">
                ...
                <ul className="py-4 flex flex-col gap-2">
                    ...
                    <div
                        className="flex justify-start items-center gap-1 px-2 rounded-sm hover:bg-gray-200 cursor-pointer"
                        onClick={() => setShowModal(true)}
                    >
                        <UserStar className="h-4 w-4 text-primary" />
                        <li className="py-1">Gerar Leads</li>
                    </div>
                </ul>
            ...
            <MessageModal
                ...
                message="Você acessou um recurso Premium!"
                description="Para desbloquear essa tela, considere escolher um dos nossos planos"
            />
        </>
    );
}